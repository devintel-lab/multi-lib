function [blob_size, blob_center, blob_cells] = detect_color_object_5(img, agent_type, obj_num, obj_params) % blob_cells
...
blob_cells{3} = (h > obj_params.green_h_low) & (h < obj_params.green_h_high) & ...
    (s > obj_params.green_s_low)  & ~bk; % green object
...
blob_cells{5} = (h > obj_params.yellow_h_low) & (h < obj_params.yellow_h_high) & ...
    (s > obj_params.yellow_s_low) & (v > obj_params.yellow_v_low) & ~bk; % yellow  object
blob_cells{6} = (h > obj_params.pink_h_low) & (h < obj_params.pink_h_high) & ...
    (s > obj_params.pink_s_low) & (v > obj_params.pink_v_low) & ~bk; % pink object
