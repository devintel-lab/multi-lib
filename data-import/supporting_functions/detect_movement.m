function [fixations_merged raw, speed] = detect_movement(position, params)
%Detect_movement examines position data to return a cevent
%
%[fixations_merged raw] = detect_movement(position, params)
%
...
%     params.thresh_lo:  Lower  threshold of movement. It's in cm/sec
%     params.thresh_hi:  Higher threshold of movement. It's in cm/sec
%     params.fixation_creep:   It's in cm.
%     params.min_fixation:     It's in second
%     params.fixation_filter:  It's in second
% 
% The cevent returned has 3 states:
%   1: stationary
%   2: moving above the low-threshold
%   3: moving above the hi-threshold.
%  

speed = cont_speed(position);
%speed(:, 2) = medfilt1(speed(:, 2), 20);
