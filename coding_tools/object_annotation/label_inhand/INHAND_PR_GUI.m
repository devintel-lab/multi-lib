...
% Edit the above text to modify the response to help INHAND_PR_GUI
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @INHAND_PR_GUI_OpeningFcn, ...
                   'gui_OutputFcn',  @INHAND_PR_GUI_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before INHAND_PR_GUI is made visible.
function INHAND_PR_GUI_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to INHAND_PR_GUI (see VARARGIN)

% Choose default command line output for INHAND_PR_GUI
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes INHAND_PR_GUI wait for user response (see UIRESUME)
...
function varargout = INHAND_PR_GUI_OutputFcn(hObject, eventdata, handles) 
...
if isempty(coder_name)
	existing_data = [subject_dir '/extra_p/' subject '_PR_INHAND.mat'];
else
	existing_data = [subject_dir '/extra_p/' subject '_PR_INHAND_' coder_name '.mat'];
end
...
if isempty(coder_name)
	save([subject_dir '/extra_p/' subject_name '_PR_INHAND.mat'], 'INHAND_DATA');
  % save([subject_dir '/derived/cstream_inhand_parent_right.mat'], 'cstream_inhand');
  record_variable(get_subject_id_from_folder(handles), 'cstream_inhand_parent_right', cstream_inhand);
else
	save([subject_dir '/extra_p/' subject_name '_PR_INHAND_' coder_name '.mat'], 'INHAND_DATA');
  % save([subject_dir '/extra_p/cstream_inhand_parent_right_' coder_name '.mat'], 'cstream_inhand');
  record_variable_into_specified_directory(get_subject_id_from_folder(handles), 'extra_p', ['cstream_inhand_parent_right_' coder_name], cstream_inhand);
end
