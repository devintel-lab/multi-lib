...
% rewrite the get_age_at_exp
% add all exp to allsubs var
...
% [~,allsubs] = cIDs([12 14 15 17 29 32 34 35 39 41 43 44 49 65 66 67 68 69 70 71 72 73 74 75 76 58 59 47 87 91:94 100:154]);
[~,allsubs] = cIDs(unique(list_experiments));
