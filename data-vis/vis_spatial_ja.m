...
if ~isfield(args, 'xydataCol')
    warning('[!] No args.xydataCol detected. Using default configurations: args.xydataCol = [2, 3]')
    args.xydataCol = [2, 3];
end
...
for sub = subIDs'
    ...
    try
        ...
        for i = 1:numel(ja_duration)
            ...
            plot(gca, [nanmean(c_head(a:b, args.xydataCol(1))) nanmean(p_head(a:b, args.xydataCol(1)))], [nanmean(c_head(a:b, args.xydataCol(2))) nanmean(p_head(a:b, args.xydataCol(2)))], ...
                'Color', predefined_colors(ja_obj(i), :), 'LineWidth', args.lineWidth)
            plot(gca, nanmean(c_head(a:b, args.xydataCol(1))), nanmean(c_head(a:b, args.xydataCol(2))), ...
            ...
            plot(gca, nanmean(p_head(a:b, args.xydataCol(1))), nanmean(p_head(a:b, args.xydataCol(2))), ...
