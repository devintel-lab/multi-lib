...
function [] = draw_and_save_heatmap_image(SUBJ, gaze_data, FOLDER, EVENT_VAR, SUBJECT, num_trials, TARGET_RESOLUTION, NEGATE_EVENT)
	...
	mtit([num2str(SUBJ) ', ' strrep(EVENT_VAR, '_', ' ') neg ', ' SUBJECT ' view'], 'FontSize', 16, 'xoff', 0, 'yoff', 0.03, 'zoff', 0);
	...
	print(f, [save_dir num2str(SUBJ) '_eyegaze_' EVENT_VAR '_' neg lower(SUBJECT) 'view.png'], '-dpng');
